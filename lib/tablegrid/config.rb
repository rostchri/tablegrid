...
module Tablegrid
  ...
  class Configuration
    ...
    config_accessor :actions, :table_class, :vtable_class, :heading_class, :th_class, :tr_class, :td_class, :numeric_td_class, :string_td_class, :date_td_class, :even_odd, :paginator_pos, :i18n
